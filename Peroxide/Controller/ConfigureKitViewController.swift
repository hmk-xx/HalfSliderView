//
//  ConfigureKitViewController.swift
//  Peroxide
//
...
class ConfigureKitViewController: UIViewController {

    override func viewDidLoad() {
        super.viewDidLoad()
        self.customizeNavigationBarWithSlideButton()
        self.methodNavigationBarBackGroundAndTitleColor(NSLocalizedString("ConfigureKit", comment: ""))
