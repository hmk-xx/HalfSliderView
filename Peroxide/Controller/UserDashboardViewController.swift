...
class UserDashboardViewController: UIViewController{
   // @IBOutlet weak var collectionViewVendorItems: UICollectionView?
    @IBOutlet var labelCheck:UILabel?

    override func viewDidLoad() {
        super.viewDidLoad()
        self.customizeNavigationBarWithSlideButton()
        self.methodNavigationBarBackGroundAndTitleColor(NSLocalizedString("AppSettings", comment: ""))
        ...
        self.labelCheck?.text =  NSLocalizedString("Title", comment: "")
